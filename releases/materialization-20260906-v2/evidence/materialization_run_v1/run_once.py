...
AUTH_ID = 'MATERIALIZATION-ONLY-20260906-B123293DFE33-AUTHORIZED'
...
def prepare():
    expected = {'MATERIALIZATION_FINAL_REQUEST_V1.zip': 'b123293dfe331d59393688d07c799c1fdb42f0df2367ef919c2f949843bff655',
        'MATERIALIZATION_REBIND_EVIDENCE_V1.zip': '509074b8e52786118a5b338f8e9f1b86606b999508bd9273465280d01e76223e',
...
def execute():
    ...
    command=[sys.executable,'-B','-u',str(PACKAGE/'scripts/materialize_dataset_native_v1r2.py'),
        ...
        '--executor-evidence-zip',str(WORK/'MATERIALIZATION_REBIND_EVIDENCE_V1.zip'), '--decisions',str(DECISIONS),
